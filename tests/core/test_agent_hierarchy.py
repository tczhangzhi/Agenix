...
class TestAgentHierarchy:
    ...
    def test_agent_has_unique_id(self):
        ...
        config = AgentConfig(model="gpt-3.5-turbo", api_key="test-key")
    ...
    def test_agent_parent_chain_default_empty(self):
    ...
    def test_agent_with_parent_chain(self):
    ...
    def test_parent_chain_immutability(self):
    ...
    def test_agent_id_in_parent_chain_detection(self):
...
class TestAgentHierarchyUseCases:
    ...
    def test_circular_reference_prevention_data_structure(self):
    ...
    def test_agent_without_hierarchy_params_still_works(self):
